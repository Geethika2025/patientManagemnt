  ...
  return (
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-12 flex-1">
        <section className="mb-12 space-y-4">
          ...
          <p className="text-white">Lets knoew more about yourself</p>
        </section>
        <section className="mb-12 space-y-6">
        <div className="mb-9 space-y-1">
        <h2 className="text-white text-18-bold md:text-24-bold">Personal information</h2>
        </div>
        </section>
        <CustomFormField 
        ...
        <CustomFormField 
              ...
              name="address"
              label="Address"
              placeholder="14th Street,New Yeork"
         ...
         <section className="mb-12 space-y-6">
        <div className="mb-9 space-y-1">
        <h2 className="text-white text-18-bold md:text-24-bold">Medical information</h2>
        </div>
        </section>
